...
export default function ShowcaseAnimation() {
  ...
  useEffect(() => {
    ...
    const runTour = async () => {
      ...
      setScene(
        1,
        "Step 1 · From Google to korra.space",
      ...
      setStatus("Step 1 of 5 · Launching korra.space");
      await sleep(1200);
      ...
      setScene(
        2,
        "Step 2 · Inspect Gold",
        "Focus on the live gold feed and move through the interface quickly."
      );
      await runStep({
      ...
      await runStep({
        label: "Inspecting Gold",
        selector: "button.watchlist-row",
        text: "GOLD",
        zoom: 1.14,
        followCursor: false,
        waitAfter: 1100,
        calloutTitle: "Gold Feed",
        calloutDetail: "The interface stays centered on a single live gold market.",
        calloutSide: "left",
        calloutFocus: "Gold Spot"
      });
      ...
      await runStep({
        ...
        calloutDetail: "Korra appears as a Person with a dedicated account number.",
        calloutSide: "left",
        calloutFocus: "Korra (Person)"
      });
      await runStep({
  ...
  return (
    <section className={styles.stage}>
      ...
      <div className={styles.heroPanel}>
        <span className={styles.heroKicker}>KORRA.SPACE</span>
        <motion.h1
          key={featureTitle}
          ...
          <div className={styles.browserWindow}>
            <div className={styles.browserChrome}>
              ...
              <div className={styles.addressBar}>
                {introPhase === "search" ? "google.com" : "korra.space"}
              </div>
            </div>
            ...
            {introPhase === "loading" ? (
              <div className={styles.loadingPane}>Opening korra.space...</div>
            ) : null}
          </div>
        </motion.div>
      ) : null}
